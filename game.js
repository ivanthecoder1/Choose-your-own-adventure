...
async function playerInfo() {
    // the await keyword is used with asynchronous functions to pause their execution until the awaited promise is resolved. 
    // It allows the code to wait for the completion of asynchronous operations 
    // before proceeding to the next step, making it easier to work with asynchronous logic
...
// Handles the answer to the left question, can choose the right answer in the question
